...
class Partner(Base):
    ...
    partner_name = Column(String(200), nullable=False, index=True)
    joining_date = Column(String(50), nullable=True) # Auto added joining date
    partner_type = Column(String(50), nullable=True, default="Service")  # Service, Partner with %
    partner_share_percentage = Column(Float, nullable=True, default=0.0)
    is_rbs = Column(Boolean, nullable=False, default=True)
    rbs_type = Column(String(20), nullable=True, default="Credit")  # Credit, Debit
